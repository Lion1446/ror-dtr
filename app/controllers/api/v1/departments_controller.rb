class Api::V1::DepartmentsController < Api::V1::BaseController
  ...
  def index
    ...
    render json: {
      departments: DepartmentSerializer.new(departments).serializable_hash,
  ...
  def create
    ...
    if department.save
      render json: DepartmentSerializer.new(department).serializable_hash, status: :created
    else
  ...
  def show
    ...
    render json: DepartmentSerializer.new(department).serializable_hash, status: :ok
  end
